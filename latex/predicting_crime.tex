...
Figure \ref{figx} shows our design flow diagram\footnote{DUMBO refers to NYU's High Performance Computing Hadoop cluster}. All three data sources were downloaded into NYU's Hadoop cluster and cleaned using MapReduce. We then analyzed the data using Spark with the data stored as Spark's SQL tables. 
